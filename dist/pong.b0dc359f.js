...
})({"8YywJ":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "61afca04b0dc359f";
...
},{}],"esSrG":[function(require,module,exports) {
var _rage = require("./rage");
let rage;
const winWidth = 1280;
const winHight = 720;
const main = ()=>{
    rage = new (0, _rage.Rage)("pong-canvas", winWidth, winHight);
...
const update = ()=>{
    ...
    const dt = rage.getDT();
    //player1 / Left paddle
    if (rage.isKeyDown("a")) paddles.P1Y -= paddles.Speed * dt;
    if (rage.isKeyDown("z")) paddles.P1Y += paddles.Speed * dt;
    if (paddles.P1Y >= winHight - paddles.P1Height) paddles.P1Y = winHight - paddles.P1Height;
    else if (paddles.P1Y <= 0) paddles.P1Y = 0;
    ...
    if (rage.isKeyDown("k")) paddles.P2Y -= paddles.Speed * dt;
    if (rage.isKeyDown("m")) paddles.P2Y += paddles.Speed * dt;
    if (paddles.P2Y >= winHight - paddles.P2Height) paddles.P2Y = winHight - paddles.P2Height;
    else if (paddles.P2Y <= 0) paddles.P2Y = 0;
...
},{}]},["8YywJ","esSrG"], "esSrG", "parcelRequire5a2c")

//# sourceMappingURL=pong.b0dc359f.js.map
